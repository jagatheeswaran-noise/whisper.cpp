...
private const val BASE_PROMPT = "Voice commands, Start Running, stop, start, record, play, pause, resume, next, previous, open, left, right, go, back, exit, set an alarm, timer, stopwatch, set timer to 5 min, set active hours goal to 2 hours, set active minutes goal to 25 min start stopwatch, stop timer, reset stopwatch, pause timer, resume timer, mute, unmute, brightness up, brightness down, increase, decrease, dim, silence, music, song, track, what's the weather today, weather tomorrow, forecast, rain, snow, air quality, steps today, steps this week, weekly steps, sleep score, sleep score yesterday, sleep score last week, what is my heart rate today, weekly heart rate, how much calories today, calories yesterday, spo2 level today, spo2 yesterday, stress alert, set stress 80%, set heart rate high to 120, set heart rate low to 50, set spo2 low to 90, set distance goal 5 km, set steps goal to 10000, set calories goal for 2000, update sleep goal to 8 hours, hiking, running, walking, treadmill, swimming, rowing, yoga, meditation, cycling, indoor cycling, strength training, workout start, workout stop, workout pause, open weather, open spo2, measure spo2, last week, yesterday, today, tomorrow, DND, enable DND, disable DND, AOD on, AOD off, raise to wake on, raise to wake off, change brightness level to"
